  ...
  riddles: [
    {
      ...
      hint: "На кухне спрятано за тем, что купила «для пользы», а потом спокойно забыла."
    },
    {
      number: "02",
      title: "Вторая карточка",
      hint: "Там, где экран загорается не для фильма, а для чужих миров и ещё одной попытки."
    },
    {
      number: "03",
      title: "Третья карточка",
      hint: "За тем, что ты мне когда-то подарила, а круглые герои до сих пор живут между страницами."
    },
    {
      number: "04",
      title: "Четвёртая карточка",
      hint: "За коробочками с приключениями для той приставки, которую можно унести с собой."
    },
    {
      number: "05",
      title: "Пятая карточка",
      hint: "Под тем, что я достаю, когда нужно за что-то заплатить."
    }
  ]
};
